// Metadata: TNCG15 Project Page
// Title: TNCG15 - Advanced Global Illumination
// Description: Advanced global illumination and rendering techniques
...
export default function TNCG15() {
  const [content, setContent] = useState('');

  useEffect(() => {
    fetch('/projects/TNCG15/README.md')
      .then((response) => {
