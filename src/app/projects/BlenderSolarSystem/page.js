// Metadata: BlenderSolarSystem Project Page
// Title: Blender Solar System
// Description: A solar system visualization created in Blender
...
export default function BlenderSolarSystem() {
  ...
  useEffect(() => {
    fetch('/projects/BlenderSolarSystem/README.md')
      .then((response) => {
